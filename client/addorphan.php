<?php
    if (isset($_POST['submit']))
    {
        ...
        $query3 = "INSERT INTO o_referral(orphanID, socialWorkerName, socialWorkerEmail, endorserAgency, referralDate, referralCode) VALUES ('$orphan_id', '$_POST[swname]', '$_POST[swemail]', '$_POST[endorser]', '$today', '$password')";
       ...
       //if (!empty($_POST["swid"]))
        //{
            ...
            echo "<script>";
            echo "swal('Application is submitted. Please remember this code for viewing. Referral Code:".$password."');";
