      ...
      echo "<div class='modal fade' role='dialog' id='photo".$id."'>
          ...
          <div class='modal-dialog'>
            <div class='modal-content'>
              ...
              <div class='modal-body'>
                <p>You are accepting the social worker application from ".$res['firstName'].' '.$res['lastName'].".</p>
                ...
                <form method='post' action='backend/acceptsw.php'>
            ...
            <div class='row'>
              <div class='col-6'>
                <label>Email</label>
                <input type='text' class='form-control' name='usern' style='margin-left: 0px;' id='email' value='".$res['email']."' readonly/>
              </div>
              <div class='col-6'>
                <label>Password</label>
                <input type='text' class='form-control' name='check' id='check".$id."' required/>
              </div>
            </div>
              </div>
