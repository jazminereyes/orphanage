  ...
  <div class="content-wrapper" style="background-color: #2dcc70">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <center><h1 class="m-0 text-light"><strong>REFERRALS</strong></h1></center>
          </div><!-- /.col -->
          <div class="col-sm-12">
              ...
              <div class='modal-body'>
                        ...
                        <div class='row'>
                          ...
                          <div class='col-lg-3'>
                            ...
                            <input type='text' class='form-control swd' name='cname' value='".$name."' style='margin: 0' disabled/>
                          </div>
                          <div class='col-lg-3'>
                            <label for='place' id='pfound'>Place Found</label>
                            <input type='text' class='form-control swd' name='place' value='".$res['placeFound']."' style='margin: 0' disabled />
                          </div>
                          <div class='col-lg-3'>
                            <label for='refdate' id='bday'>Birthdate</label>
                            <input type='text' class='form-control dt' name='bdate' value='".$res['birthdate']."' style='margin: 0' disabled/ >
                          </div>
                        </div><br/>
                        ...
                        <div class='row'>
                          <div class='col-lg-4'>
                            ...
                            <input type='text' class='form-control swd' name='swname' value='".$s['firstName']." ".$s['lastName']."' style='margin: 0' disabled/>
                          </div>
                          <div class='col-lg-4'>
                            <label for='swemail' id='semail'>Social Worker Email</label>
                            <input type='text' class='form-control swd' name='swemail' value='".$s['email']."' style='margin: 0' disabled/>
                          </div>
                          <div class='col-lg-4'>
                            <label for='swemail' id='semail'>Endorser Agency</label>
                            <input type='text' class='form-control swd' name='swemail' value='".$s['endorserAgency']."' style='margin: 0' disabled/>
                          </div>
                        </div><br/>
    ...
    <div id='accept".$id."' class='modal fade' role='dialog'>
      <div class='modal-dialog'>
        <div class='modal-content'>
          ...
          <div class='modal-body'>
            <p>You are accepting the referral from ".$res['socialWorkerName'].". You may send an email to notify them.</p>
            <label for='email'>TO:</label>
            <div class='input-group mb-3'>
                  <div class='input-group-prepend'>
                    <span class='input-group-text'><i class='fa fa-envelope'></i></span>
                  </div>
                  <input type='email' class='form-control' value='".$res['socialWorkerEmail']."' disabled>
            </div>
          ...
          <div class='modal-footer'>
            ...
            <form method='post' action='backend/acceptorphan.php'>
    ...
    <div id='decline".$id."' class='modal fade' role='dialog'>
          <div class='modal-dialog'>
            <div class='modal-content'>
              ...
              <div class='modal-body'>
                <p>You are declining the referral from ".$res['socialWorkerName'].". You may send an email to notify them.</p>
                <label for='email'>TO:</label>
            <div class='input-group mb-3'>
                  <div class='input-group-prepend'>
                    <span class='input-group-text'><i class='fa fa-envelope'></i></span>
              ...
              <div class='modal-footer'>
                <button type='button' class='btn btn-outline pull-left' data-dismiss='modal'>Cancel</button>
                <form method='post' action='backend/declineorphan.php'>
                <input type='hidden' value='".$id."' name='oid'/>
                <input type='submit' name='submit' class='btn btn-success' value='Confirm'/>
            </form>
              </div>
