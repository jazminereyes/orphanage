          ...
          <div class='modal-dialog'>
            <div class='modal-content'>
                ...
                <form method="post" action="backend/insertacct.php" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      ...
                      <input type="text" class="form-control" maxlength="11" name="pass" id="password" required/>
                    </div>
                  </div><br/>
              ...
              <div class='modal-footer'>
                ...
                <input type="submit" value="Confirm" name="submit" class="btn btn-outline btn-success" onclick="validatePassword()"/>
                </form>
              </div>
            </div>
            <!-- /.modal-content -->
