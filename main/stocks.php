              ...
              <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                      ...
                      while($stock = mysqli_fetch_array($qry)){
                        ...
                        {
                            $st = "Scholar";
                            $select = "<select class='form-control' name='stocktype'><option value='S' selected>Scholar</option>
                                                <option value='O'>Orphan</option>
                                                <option value='G'>General</option></select>";
                        }

                        else if ($stock['stockType']=='O')
                        {
                            $st = "Orphan";
                            $select = "<select class='form-control' name='stocktype'><option value='S'>Scholar</option>
                                                <option value='O' selected>Orphan</option>
                                                <option value='G'>General</option></select>";
                        }

                        if ($stock['stockType']=='G')
                        {
                            $st = "General";
                            $select = "<select class='form-control' name='stocktype'><option value='S'>Scholar</option>
                                                <option value='O'>Orphan</option>
                                                <option value='G' selected>General</option></select>";
                        }
                        ...
                        echo "<td>".$st."</td>";
                        echo "<td><a href='#edit".$stock['stockNo']."' data-toggle='modal'>
                                  <button type='button' class='btn btn-primary'><i class='fa fa-edit'></i>&nbsp;&nbsp;Edit</button></a>
                              
                                  <div id='edit".$stock['stockNo']."' class='modal fade' role='dialog' >
                                  <div class='modal-dialog'>
                                    <div class='modal-content'>
                                      ...
                                      <div class='modal-body'>
                                        ...
                                        <form method='post' action='backend/editstock.php'>
                                          <div class='form-inline'>
                                            <label for='iname' id='name'>Item Name</label>
                                            <input type='text' class='form-control' name='item' value='".$stock['itemName']."'/><br/>
                                          </div>
                                          <div class='form-inline'>
                                            <label for='iname' id='name'>Critical Amount</label>
                                            <input type='number' class='form-control' name='critical' min='0' value='".$stock['criticalAmount']."'/><br/>
                                          </div>
                                          <div class='form-inline'>
                                            <label for='iname' id='name'>Stock Type</label>
                                            ".$select."
                                          </div>
                                      </div>
