      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <div class="btn-group">
              ...
              <a href="scholar2.php" class="text-light" style="text-decoration: none"><button type="button" class="btn btn-success">List View&nbsp&nbsp&nbsp&nbsp<i class="fa fa-list"></i></button></a>
            </div>
        </div>
        <div class="col-md-3">
        ...
        <ul>
          <?php
            ...
            $query = "SELECT scholarID, firstName, lastName, person.photo, currentYrLevel, middleName FROM person LEFT JOIN scholar on person.personID = scholar.personID WHERE type = 'S' AND applicationStatus = 'Accepted'";
            ...
            elseif($yrlvl == "SHS_G12"){
              ...
              echo '<div class="text-center">
                  <img class="profile-user-img img-fluid"
                    ...
                    echo "<center><img class='photo' src='../".$res[3]."' height='100' width='100' ></center>";

                    // 
                  }

                      echo "<center><a class='orphan' href='viewscholar.php?scholarid=".$res[0]."'>".$res[1]." ".$res[2]."</a></center>";
