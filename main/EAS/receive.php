                      ...
                      <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                          ...
                          <div class="form-inline">
                            ...
                            <input type="number" class="form-control" name="critical"/><br/>
                          </div>

                          <div class="form-inline">
                            <label>Stock Type</label>
                            <select class="form-control" name="stocktype">
                          ...
                          <div class="form-inline">
                            ...
                            <input type="date" class="form-control" name="dreceive"/><br/>
                          </div>

                          <div class="form-inline">
                            <label for="iname" id="name">Quantity Received</label>
                            <input type="number" class="form-control" min="0" name="qty"/><br/>
                          </div><br/>
                          ...
                          <div class="tab-pane" id="tab_2">
                            ...
                            <div class="form-inline">
                            <label for="iname" id="name">Reference Number</label>
                            <input type="text" class="form-control" name="refno"/><br/>
                          </div>

                          <div class="form-inline">
                            <label for="iname" id="name">Date Received</label>
                            <input type="date" class="form-control" name="daterec"/><br/>
                          </div>

                          <div class="form-inline">
                            <label for="iname" id="name">Quantity Received</label>
                            <input type="number" class="form-control" min="0" name="qtyreceive"/><br/>
                          </div><br/>
            ...
            <div class="card-body" id="rtbl">
              <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                      ...
                      $sql = "SELECT * FROM a_receive JOIN a_stocks ON a_receive.stockNo = a_stocks.stockNo WHERE stockType = 'S' OR stockType = 'G'";
