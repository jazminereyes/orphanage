        ...
        <div class="row mb-2">
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">List of Sponsors per Sponsorship Type</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
     ...
     <div class="row">
        <div class="col-md-10" style="margin-left: 100px">
          <div class="card">
            ...
            <div class="card-body">
            <center><h4>List of Sponsors per Sponsorship Type</h4></center>
                <div class="row">
                ...
                <?php
                    ...
                    if (isset($_POST["submit"])){
                        ...
                        echo "<center><h4>List of Sponsors per Sponsorship Type</h4></center>";
                        ...
                        $query = "SELECT concat(firstName, ' ', lastName) AS Name, country AS Country, scholarCount AS 'Number of Scholars' FROM person JOIN sponsor ON person.personID = sponsor.personID WHERE donationType = '$sponsor' AND applicationStatus = 'A'";
