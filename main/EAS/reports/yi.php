                ...
                <?php
                    ...
                    if(isset($_POST['submit'])){
                        ...
                        if($type=='purchased'){
                            ...
                            $query = "SELECT SUM(qtyAdjusted) FROM a_adjustment WHERE dateAdjusted LIKE '$year-%-%' AND remarks = 'Damaged'";
                            $result = mysqli_query($con, $query);
                            $row = mysqli_fetch_row($result);

                            $count = $row[0];

                            echo "<br/><br/><center><h4>".$year." - Damaged Items</h4></center>";

                            $title = $year." - Damaged Items";
