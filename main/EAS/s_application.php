                  ...
                  ?>
                        ...
                        while($parent = mysqli_fetch_array($sql2)){
                          ...
                          if($parent['relationType'] == "Mother"){
                            ...
                            $msis = $parent['noOfSisters'];
                            $mbro = $parent['noOfBrothers'];
                          ...
                          elseif($parent['relationType'] == "Father"){
                            ...
                            }                            $fsis = $parent['noOfSisters'];
                            $fbro = $parent['noOfBrothers'];
                        ...
                        ?>
                          ...
                          <div class="text-center"> 
                            ...
                            <input type="number" class="form-control" id="inputPlace" name="mbro" value="<?php echo $mbro ?>" disabled /> <br/>
                            ...
                            <div class="form-inline">
                            <label for="inputPlace" style="margin-right: 20px">Brother</label>
                            <input type="text" class="form-control" id="inputPlace" name="fbro" value="<?php echo $fbro ?>" disabled /> <br/>
                            <label for="inputPlace" style="margin-left: 30px; margin-right: 20px;">Sister</label>
