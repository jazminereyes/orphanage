                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                            ...
                            <div class="form-group">
                              ...
                              <?php
                                $select = "SELECT person.personID, firstName, lastName FROM person JOIN scholar ON person.personID = scholar.personID WHERE type = 'S' AND applicationStatus = 'Accepted'";
            ...
            <div class="card-body" id="rtbl">
              <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                      ...
                      $sql = "SELECT * FROM a_stocks JOIN a_release JOIN person JOIN a_unit ON a_stocks.stockNo = a_release.stockNo AND a_release.personID = person.personID AND a_stocks.unitID = a_unit.unitID WHERE stockType = 'S' OR stockType = 'G'";
