  ...
  <div class="content-wrapper">
       ...
       <div class="row">
          <div class="col-sm-12">
            <ol class="breadcrumb float-right">
              ...
              <li class="breadcrumb-item"><a href="app_scholar.php" class="text-light">Pending Applications</a></li>
              <?php
                ...
                $query = "SELECT firstName, lastName, person.personID FROM person JOIN scholar on person.personID = scholar.personID WHERE scholarID = $scholar_id";
                ...
                echo '<li class="breadcrumb-item active">'.$rec[0].' '.$rec[1].'</a></li>';
              ?>
    ...
    <section class="content">
      <div class="container-fluid">
                  ...
                  ?>
                        ...
                        ?>
                          ...
                          <div class="text-center"> 
                            ...
                            <input type="number" class="form-control" id="inputPlace" name="mbro" value="<?php echo $mch ?>" disabled /> <br/>
                            </div><br/>
                            ...
                            <div class="form-inline">
                            <label for="inputPlace" style="margin-right: 20px">No. of Children</label>
                            <input type="text" class="form-control" id="inputPlace" name="fbro" value="<?php echo $fch ?>" disabled /> <br/>
                            </div><br/>
          ...
          <div class="text-center">
            <a href='' data-toggle="modal" data-target="#accept"><button class="btn btn-lg btn-success btn-flat">Accept</button></a>&nbsp;&nbsp;&nbsp;&nbsp;
            <a href='' data-toggle="modal" data-target="#decline"><button class="btn btn-lg btn-danger btn-flat">Decline</button></a>
        </div>

          <div id="accept" class="modal fade" role="dialog" style="color: black">
                ...
                <form method="post" action="backend/acceptsch.php" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <div class="col-6">
                      ...
                      <input type="date" class="form-control" name="admission" required />
                    </div>
                  </div><br/>
        ...
        <!-- /.modal -->
         ...
         <div id="decline" class="modal fade" role="dialog" style="color: black">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title">Application Details</h4>
              ...
              <div class="modal-body">
                ...
                <form method="post" action="backend/declinesch.php" enctype="multipart/form-data">
                  
                  <h4 class="text-center">Are you sure you want to decline the application?</h4>
