...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="RH/css/list.css">
    <link rel="stylesheet" type="text/css" href="RH/css/assmt.css">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="assetlist.php" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>List</p>
                </a>
              </li>
            ...
            <div class="card-header">
                ...
                <div class="btn-group float-right">
                    ...
                    <button type="button" class="btn btn-success btn-flat" data-toggle='modal' data-target='#modal-default' style="margin-left: 20px">
                      <span>Release Supply&nbsp&nbsp</span>
                      <i class="fa fa-plus"></i>
                    </button>
              ...
              echo '<div class="modal-body">
                  ...
                  <label for="iname" id="name">Item Name</label>
                    ...
                    while($res = mysqli_fetch_array($qwe)){
                      ...
                      $x = "SELECT personID, firstName, last FROM person WHERE type='S'";
