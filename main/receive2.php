...
<script>
  ...
  function changeTextbox(){
    if (document.getElementById('anon').checked){
      document.getElementById('donor').disabled = true;
    } else{
      document.getElementById('donor').disabled = false;
    }
  }

  function changeText(){
    if (document.getElementById('anons').checked){
      document.getElementById('donors').disabled = true;
    } else{
      document.getElementById('donors').disabled = false;
    }
  }
</script>
  <!-- SCRIPTS -->
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="receive2.php" class="nav-link active">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Receive</p>
                </a>
              </li>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                          ...
                          <div class="form-inline">
                            <label for="iname" id="name">Critical Quantity</label>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                          ...
                          <div class="nav-tabs-custom">
                        <ul class="nav nav-pills ml-auto p-2">
                          <li class="nav-item"><a class="nav-link active custom" href="#tab_5" data-toggle="tab">New Item</a></li>
                          <li class="nav-item"><a class="nav-link custom" href="#tab_6" data-toggle="tab">Existing Item</a></li>
                        </ul>
