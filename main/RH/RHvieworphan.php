                        ...
                        <div class='modal-dialog'>
                          <div class='modal-content'>
                            ...
                            <div class='modal-footer'>
                              ...
                              <input type='hidden' value='".$orphan_id."' name='oid'/>
                              ".$button."
                          </form>
                            </div>
                          </div>
                  ...
                  <?php
                      ...
                      echo '<div class="row">
                              ...
                              <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="adate" class="or" name="admission" value="'.$rec[4].'" style="margin: 0" disabled><br/>
                              </div>
                              <div class="col-md-4">
                                <label id="bd">Birthdate</label>
                                <input type="text" class="form-control" id="bdate" class="or" name="birthdate" value="'.$rec[5].'" style="margin: 0" disabled>
                              </div>
                            </div>';
