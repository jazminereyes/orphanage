        ...
        <div class="row mb-2">
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="socialworker.php" class="text-light">Social Workers</a></li>
          ...
          <div class="col-md-3">
            ...
            if($g['photo'] == ""){
              /*echo '<center><div style="margin-bottom: 10px;">
                ...
                echo '<center><h4>'.$g['firstName'].' '.$g['lastName'].'</h4></center><hr>';
