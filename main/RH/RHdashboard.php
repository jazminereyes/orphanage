              ...
              <div class="info-box-content">
                ...
                <?php
                  ...
                  if ($c[0]>0)
                  {
                    ...
                    '.$c[0].'
                  <small><a href="RHlist.php" class="pull-right"><button class="btn btn-danger btn-sm">View</button></a></small></span>';
                  }
          ...
          <div class="col-md-6">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <label>Total Count: <?php echo $row[0]; ?>
                </label>
              </div>
            </div>
          </div>
...
<script>
    ...
    var getMale = function(){
      return <?php
        $select = "SELECT COUNT(orphanID) FROM person JOIN orphan ON person.personID = orphan.personID WHERE person.gender = 'M' and applicationStatus = 'Accepted' OR applicationStatus = 'Processing'";
    ...
    var getFemale = function(){
      return <?php
        $sel = "SELECT COUNT(orphanID) FROM person JOIN orphan ON person.personID = orphan.personID WHERE person.gender = 'F' and applicationStatus = 'Accepted' OR applicationStatus = 'Processing'";
    ...
    var getNeglected = function(){
      return <?php
        $gn = "SELECT COUNT(orphanID) FROM orphan WHERE caseStatus = 'Neglected' AND applicationStatus = 'Accepted' OR applicationStatus = 'Processing'";
    ...
    var getFoundling = function(){
      return <?php
        $gf = "SELECT COUNT(orphanID) FROM orphan WHERE caseStatus = 'Foundling' AND applicationStatus = 'Accepted' OR applicationStatus = 'Processing'";
    ...
    var getAbandoned = function(){
      return <?php
        $ga = "SELECT COUNT(orphanID) FROM orphan WHERE caseStatus = 'Abandoned' AND applicationStatus = 'Accepted' OR applicationStatus = 'Processing'";
