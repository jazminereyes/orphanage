        ...
        <div class="row mb-2">
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">List of Adopted Orphans</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
     ...
     <div class="row">
        <div class="col-md-10" style="margin-left: 100px">
          <div class="card">
            ...
            <div class="card-body">
            <center><h4>List of Adopted Orphans</h4></center>

                <?php

                    require ('../../../connection.php');

                    $query = "SELECT concat(firstName, ' ', lastName) AS Name, placeFound AS 'Place Found', admissionDate AS 'Admission Date', adoptionDate AS 'Adoption Date' FROM person JOIN orphan JOIN o_adoptiondetails on person.personID = orphan.personID and orphan.orphanID = o_adoptiondetails.orphanID WHERE applicationStatus = 'Adopted'";
                    ...
                    echo '<br/><a href="genpdf.php?query='.$query.'&title=List of Adopted Orphans" class="btn btn-danger" target="_blank"><i class="fa fa-print"></i>&nbsp;Print</a>';
                ?>
