        ...
        <div class="row mb-2">
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">List of Orphans for Adoption</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
     ...
     <div class="row">
        <div class="col-md-10" style="margin-left: 100px">
          <div class="card">
            ...
            <div class="card-body">
            <center><h4>List of Orphans for Adoption</h4></center>

                <?php

                    require ('../../../connection.php');

                    $query = "SELECT concat(firstName, ' ', lastName) AS Name, placeFound AS 'Place Found', admissionDate AS 'Admission Date' FROM person INNER JOIN orphan on person.personID = orphan.personID WHERE applicationStatus = 'Processing'";
                    ...
                    echo '<br/><a href="genpdf.php?query='.$query.'&title=List of Orphans for Adoption" class="btn btn-danger" target="_blank"><i class="fa fa-print"></i>&nbsp;Print</a>';
