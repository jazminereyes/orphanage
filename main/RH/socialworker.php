...
<head>
  ...
  <title>Concordia | Social Workers</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
                  ...
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <form method="post" action="db/addsw.php" enctype="multipart/form-data">
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-4">
                              ...
                              <input type="text" name="password" class="form-control" id="pword" required/>
                            </div>
                          </div>
                      </div>
                      ...
                      <div class="modal-footer">
                        ...
                        <input type="submit" name="submit" class="btn btn-success" value="Add Social Worker" onclick="validateDate(); validatePassword();"/>
                        </form>
                      </div>
                    </div>
            <!-- /.modal-content -->
      ...
      <div class="row">
        ...
        <tbody>
                    <?php
                        $query = "SELECT socialWorkerID, firstName, lastName, endorserAgency, email FROM person JOIN socialworker ON person.personID = socialworker.personID WHERE verifiedFlag = '1' AND activeFlag = '1'";
    ...
    <div id='terminate".$id."' class='modal fade' role='dialog'>
          <div class='modal-dialog'>
            ...
            <form method='post' action='db/inactivesw.php'>
