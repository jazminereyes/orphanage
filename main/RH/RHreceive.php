        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="RHreceive.php" class="nav-link active">
                  <i class="fa fa-circle-o nav-icon"></i>
        ...
        <div class="row mb-2">
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="#" class="text-light">Assets</a></li>
            ...
            <div class="card-body" id="rtbl">
              <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                      ...
                      $sql = "SELECT * FROM a_receive JOIN a_stocks ON a_receive.stockNo = a_stocks.stockNo WHERE stockType = 'O' OR stockType = 'G'";
