        ...
        <div class="row mb-2">
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">List of Scholars per Sponsorship Type</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
     ...
     <div class="row">
        <div class="col-md-10" style="margin-left: 100px">
          <div class="card">
            ...
            <div class="card-body">
            <center><h4>List of Scholars per Sponsorship Type</h4></center>
                <div class="row">
                    <form method="post" action="spst.php">
                        <div class="form-inline">
                            <label style="margin-left: 180px; margin-right: 10px;">Sponsorship Type</label>
                ...
                <?php
                    ...
                    if (isset($_POST["submit"])){
                        ...
                        if($st == "EM"){
                            $st = "Elementary - Monthly";
                        } elseif($st == "EY"){
                            $st = "Elementary - Yearly";
                        } elseif($st == "HSM"){
                            $st = "High School - Monthly";
                        } elseif($st == "HSY"){
                            $st = "High School - Yearly";
                        } 

                        echo "<br/><div class='col-lg-12'>";
                        echo "<center><h4>List of Scholars per Sponsorship Type</h4></center>";
                        echo "<center><h5>".$st."</h5></center>";
                        echo "</div>";

                        $title = "List of Scholars per Sponsorship Type - ".$st;

                        require('../../connection.php');

                        $query = "SELECT concat(firstName, ' ', lastName) AS Name, school AS School, scholar.sponsorID FROM person JOIN scholar JOIN sponsor on person.personID = scholar.personID AND scholar.sponsorID = sponsor.sponsorID WHERE donationType = '$sponsor' AND scholar.applicationStatus = 'Accepted'";
                        ...
                        if ($res){ 
                            ...
                            while ($rec=mysqli_fetch_array($res))
                            {
                                ...
                                $query2 = "SELECT * FROM person JOIN sponsor ON person.personID = sponsor.personID WHERE sponsorID = '$id'";
