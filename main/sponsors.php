  ...
  <div class="content-wrapper" style="background-color:#2dcc70">
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-10" style="margin-left: 100px">
          <div class="card">
            <div class="card-header">
                <center><h2>Active Sponsors</h2></center>
            </div>
        ...
        <tbody>
                    <?php
                        $query = "SELECT firstName, lastName, country, scholarCount, sponsorID, email FROM person JOIN sponsor ON person.personID = sponsor.personID WHERE applicationStatus = 'A' AND activeFlag = '1'";
