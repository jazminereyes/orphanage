        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="assetassessment.php" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Assessment</p>
                </a>
              </li>
            ...
            <div class="card-header">
                ...
                <div class="btn-group float-right">
                    ...
                    <div class="dropdown-menu" role="menu">
                      <a class="dropdown-item" data-toggle='modal' data-target='#modal-default'>Add New Item</a>
                      <a class="dropdown-item" data-toggle='modal' data-target='#modal-default4'>Add Existing Item</a>
                      <a class="dropdown-item" data-toggle='modal' data-target='#modal-default5'>Add Donation</a>
                    </div>
                </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <?php
                  ...
                  $asd = "SELECT * FROM a_asset as a JOIN a_inventory  as i ON i.assetID = a.assetID WHERE assetType='S'";
                    ...
                    <input type="submit" name="submit" class="btn btn-success" value="Add Item"/>
                        ...
                        <div class="row">
                          ...
                          <?php
                            ...
                            $asd = "SELECT * FROM a_asset WHERE assetType='S'";
                            $qwe = mysqli_query($con, $asd);

                            echo '<label for="iname" id="name">Item Name</label>
                            <select class="form-control swd" name="iname"/>';
            ...
            <div class="card-body" id="rtbl">
              <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                      ...
                      $sql = "SELECT * FROM a_asset WHERE assetType = 'S'";
                      ...
                      while($item = mysqli_fetch_array($qry)){
                        ...
                        echo "<td>".$item['criticalAmount']."</td>";
                        echo "</tr>";
                      }
