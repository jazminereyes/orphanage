                         ...
                         ;
                          ...
                          if(mysqli_num_rows($qwe) == 0){
                            echo '<center><span> No adoption details yet.</span></center>';
                              ...
                              $sql2 = "SELECT * FROM o_referral as ref JOIN orphan as op ON ref.orphanID = op.orphanID WHERE op.orphanID = '$orphan_id'";
                              $qwe2 = mysqli_query($con, $sql2);
                              $info2 = mysqli_fetch_row($qwe2);
                              echo'
                              ...
                              <input type="date" class="form-control swd" id="aemail" disabled value="'.$info2['adopterEmail'].'"/>
