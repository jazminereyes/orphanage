        ...
        <div class="col-md-10" style="margin-left: 100px">
          <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                  <div class="col-lg-4">
                    <h4>Receiving Home</h4>
                    <a href="reports/opmy.php">Orphans Admitted Per Year</a><br/>
                    <a href="reports/opcs.php">Orphans Admitted Per Case Status</a><br/>
                    <a href="reports/lofa.php">List of Orphans for Adoption</a><br/>
                    <a href="reports/loao.php">List of Adopted Orphans</a><br/>
                  </div>
                  <div class="col-lg-4">
                    <h4>Educational Assistance thru Scholarship</h4> 
                    <a href="reports/spmy.php">Scholars Admitted per Year</a><br/>
                    <a href="reports/spyl.php">Scholars per Year Level</a><br/>
                    <a href="reports/spst.php">Scholars per Sponsorship Type</a><br/>
                    <a href="reports/sp.php">Sponsors per Sponsor Type</a><br/>
                    <a href="reports/sal.php">List of Active and Inactive Sponsors</a>
                  </div>
                  <div class="col-lg-4">
                    <h4>Inventory</h4>
                    <a href="reports/mi.php">Monthly Inventory Report</a><br/>
                    <a href="reports/yi.php">Yearly Inventory Report</a>
                  </div>
                </div>
