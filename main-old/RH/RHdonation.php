        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="RHreceive.php" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                          ...
                          <div class="tab-pane" id="tab_2">
                            ...
                            <div class="form-inline">
                              ...
                              <select class="form-control" name="item" required>
                                <?php
                                  $b = "SELECT * FROM a_stocks WHERE stockType = 'O' OR stockType = 'G'";
            ...
            <div class="card-body" id="rtbl">
              <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                      ...
                      $sql = "SELECT * FROM a_donation JOIN a_stocks JOIN a_donationdetails JOIN a_unit ON a_donation.donationID = a_donationdetails.donationID AND a_stocks.stockNo = a_donationdetails.stockNo AND a_stocks.unitID = a_unit.unitID WHERE stockType = 'O' OR stockType = 'G'";
