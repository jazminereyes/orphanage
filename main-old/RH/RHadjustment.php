       ...
       <div class="card-body" id="rtbl">
         <table id="example1" class="table table-bordered table-striped">
             ...
             <tbody>
                 ...
                 $sql = "SELECT * FROM a_stocks JOIN a_adjustment JOIN a_unit ON a_stocks.stockNo = a_adjustment.stockNo AND a_stocks.unitID = a_unit.unitID WHERE stockType = 'O' OR stockType = 'G'";
