  ...
  <div class="content-wrapper">
    ...
    <div class="row">
      ...
      <div class="row">
        <div class="col-md-6">
          <label>Amount</label>
          <input class="form-control am" type="text" name="amount" id="amt" value="Php 1,250.00" readonly>
        </div>
        <div class="col-md-6">
          <label>Effectivity Period:</label>
          <input class="form-control" type="text" name="period" id="edate" value="<?php echo $row['effectivityPeriod'] ?>" readonly>
        </div>
        <br/>
      </div>
      ...
      <div class="row">
        <div class="col-md-6">
          <label>Amount</label>
          <input class="form-control am" type="text" name="amount" id="amt" value="Php 12,500.00" readonly>
        </div>
        <div class="col-md-6">
          <label>Effectivity Period:</label>
          <input class="form-control" type="text" name="period" id="edate" value="<?php echo $row['effectivityPeriod'] ?>" readonly>
      ...
      <div class="row">
        <div class="col-md-6">
          <label>Amount</label>
          <input class="form-control am" type="text" name="amount" id="amt" value="Php 1,500.00" readonly>
        </div>
        <div class="col-md-6">
          <label>Effectivity Period:</label>
          <input class="form-control" type="text" name="period" id="edate" value="<?php echo $row['effectivityPeriod'] ?>" readonly>
      ...
      <div class="row">
        <div class="col-md-6">
          <label>Amount</label>
          <input class="form-control am" type="text" name="amount" id="amt" value="Php 15,000.00" readonly>
        </div>
        <div class="col-md-6">
          <label>Effectivity Period:</label>
          <input class="form-control" type="text" name="period" id="edate" value="<?php echo $row['effectivityPeriod'] ?>" readonly>
