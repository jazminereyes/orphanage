...
function clean_text($string)
{
 ...
 return $string;
  ...
  $mail = new PHPMailer;
    ...
    $up = "UPDATE user SET username = ?, password = ?, programType = 'Social Worker' WHERE userID = '$uid'";
    ...
    if(!mysqli_stmt_prepare($stmt, $up)){
        ...
        $sel = "UPDATE socialworker SET verifiedFlag = '1' WHERE socialWorkerID = '$swid'";
        ...
        if($qry){
            if($flag == 1){
                    ...
                    echo "<script>
                                ...
                                window.location='../socialworkerapplications.php';
                                </script>";
            }
